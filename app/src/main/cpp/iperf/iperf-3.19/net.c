...
/* create a socket */
int
create_socket(int domain, int type, int proto, const char *local, const char *bind_dev,
...
int
netdial(int domain, int proto, const char *local, const char *bind_dev, int local_port,
